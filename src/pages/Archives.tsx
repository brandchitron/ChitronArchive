  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen text-gray-900 font-serif">
        <header className="mb-12 pb-6 border-b-4 border-gray-900 flex justify-between items-end">
            <div>
                <h1 className="text-5xl font-black uppercase tracking-tighter">Archives</h1>
                <p className="text-gray-500 mt-2 italic">Looking back through time.</p>
            </div>
        ...
        <div className="p-8 bg-white border border-gray-300 shadow-sm">
            <p className="text-lg text-gray-700">Archives content coming soon.</p>
        </div>
    </div>
  );
}
